//
//  SwlTemplateFieldType+SQLiteDatabaseItem.swift
//  WalletBase
//
...
extension SwlDatabase.TemplateFieldType: SQLiteDatabaseItem {
	...
	static func decode(from statement: OpaquePointer, column: Int32 = 0, nextColumn: ((Int32) -> Void)?) -> Self? {
		...
		// Decode the parts.
		var column = column
		guard let id: Int32 = .decode(from: statement, column: column, nextColumn: { column = $0 }),
		      let name: String = .decode(from: statement, column: column, nextColumn: { column = $0 }),
